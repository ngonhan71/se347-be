    ...
    createCodeVerifyEmail: async(req, res) => {
        try {
            ...
            const resultSendMail = await transporter.sendMail({
                ...
                to: email,
                subject: `[SHOPHOA] Hãy xác minh email của bạn`,
                html: ` <h2>Xin chào bạn,</h2>
                        <h3>Bạn vừa tiến hành đăng ký tài khoản tại SHOPHOA!</h3>
    ...
    handleForgotPassword: async(req, res) => {
        try {
            ...
            const resultSendMail = await transporter.sendMail({
                from: '"SHOPHOA" <se347.shophoa@gmail.com>',
                to: email,
                subject: `[SHOPHOA] Hãy đặt lại mật khẩu tài khoản của bạn`,
                html: ` <h2>Xin chào bạn ${user.fullName},</h2>
                        <p>Chúng tôi biết rằng bạn đã mất mật khẩu SHOPHOA của mình.</p>
                        <p>
